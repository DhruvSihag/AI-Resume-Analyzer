...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/DhruvSihag" style="text-decoration: none; color: #021659;">Dhruv Sihag</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by <a href="https://github.com/DhruvSihag" style="text-decoration: none; color: grey;">Dhruv Sihag</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Dhruv ! Total %d " % values + " User's Have Used Our Tool : )")                
